...
public class WKContentType extends WKMsgContentType {
    ...
    // 红包消息
    public final static int redPacket = 15;
    // 转账消息
    public final static int transfer = 16;
    // 红包被领取系统消息
    public final static int redPacketReceived = 1010;
    // 转账状态变更系统消息
    public final static int transferStatusChanged = 1011;
    //群聊加人
