...
//    private String thumbCheckedColorKey = Theme.key_windowBackgroundWhite;
    ...
    public void setDrawRipple(boolean value) {
        ...
        if (isChecked && colorSet != 2 || !isChecked && colorSet != 1) {
            int color = isChecked ? trackCheckedColorKey : trackColorKey;
    ...
    private void setChecked(boolean checked, boolean isPressed) {
        this.isPressed = isPressed;
        setChecked(checked, drawIconType, true);
    }

    private void setChecked(boolean checked, int iconType, boolean animated) {
