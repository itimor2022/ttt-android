 ...
 * 标签成员
 */
class KLabelMemberAdapter : BaseQuickAdapter<KLabelMember, BaseViewHolder>(R.layout.item_label_member_layout) {
    override fun convert(holder: BaseViewHolder, item: KLabelMember) {
