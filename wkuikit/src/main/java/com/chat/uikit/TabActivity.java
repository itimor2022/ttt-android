...
import com.chat.uikit.workplace.WorkplaceFragment;
...
//        wkVBinding.vp.setUserInputEnabled(false);
        ...
        workplaceTV.setText(R.string.tab_workplace);
        ...
        if (isShowTabText) {
            view.addView(chatIV, LayoutHelper.createFrame(iconSize, iconSize, Gravity.CENTER | Gravity.TOP, 0, 5, 0, 0));
        ...
        if (isShowTabText) {
            contactsView.addView(contactsIV, LayoutHelper.createFrame(iconSize, iconSize, Gravity.CENTER | Gravity.TOP, 0, 5, 0, 0));
        ...
        if (isShowTabText) {
            workplaceView.addView(workplaceIV, LayoutHelper.createFrame(iconSize, iconSize, Gravity.CENTER | Gravity.TOP, 0, 5, 0, 0));
        ...
        if (isShowTabText) {
            meView.addView(meIV, LayoutHelper.createFrame(iconSize, iconSize, Gravity.CENTER | Gravity.TOP, 0, 5, 0, 0));
...
//    }
    ...
    private void playAnimation(int index) {
        if (index == 0) {
            ...
            workplaceIV.setImageResource(R.mipmap.ic_workplace_n);
            if (isShowTabText) {
            ...
            chatIV.setImageResource(R.mipmap.ic_chat_n);
            contactsIV.setImageResource(R.mipmap.ic_contacts_n);
            workplaceIV.setImageResource(R.mipmap.ic_workplace_s);
            if (isShowTabText) {
                chatTV.setTextColor(ContextCompat.getColor(this, R.color.tab_text_normal));
                contactsTV.setTextColor(ContextCompat.getColor(this, R.color.tab_text_normal));
